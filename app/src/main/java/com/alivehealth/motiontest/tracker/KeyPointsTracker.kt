...
/**
 * 这段代码定义了一个 KeyPointsTracker 类，它继承自 AbstractTracker。
 * KeyPointsTracker 专注于通过关键点来追踪人体姿态，它重写了基类中的 computeSimilarity 方法
 * 来计算不同人体姿态之间的相似度。相似度的计算基于 Object Keypoint Similarity (OKS)，
 * 这是一种衡量关键点相似性的指标，常用于COCO数据集的关键点评估中。
